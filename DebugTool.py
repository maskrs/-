...
class Ui_DebugDialog(object):
    def setupUi(self, DebugDialog):
        ...
        self.lb_result = QtWidgets.QLabel(self.widget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lb_result.sizePolicy().hasHeightForWidth())
        self.lb_result.setSizePolicy(sizePolicy)
        self.lb_result.setMinimumSize(QtCore.QSize(0, 28))
...
"区域"))
        self.pb_test.setText(_translate("DebugDialog", "测 试"))
